    ...
    <header className="pointer-events-none fixed inset-x-0 top-0 z-40 px-3 pt-3 sm:px-4 sm:pt-4">
      <nav
        className={cn(
          ...
          scrolled
            ? "border-ink/10 bg-paper/85   backdrop-blur-md dark:border-cream/10 dark:bg-bgdark/85"
      ...
      {open && (
        <div className="pointer-events-auto mx-auto mt-2 max-w-6xl rounded-2xl border border-ink/10 bg-paper/95 p-2   backdrop-blur-md lg:hidden dark:border-cream/10 dark:bg-bgdark/95">
